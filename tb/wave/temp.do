...
add wave -noupdate -expand -group fft_ctrl /fft_control_tb/CONTROL/oWE_A
add wave -noupdate -expand -group fft_ctrl /fft_control_tb/CONTROL/oWE_B
add wave -noupdate -expand -group fft_ctrl /fft_control_tb/CONTROL/oSOURCE_DATA
add wave -noupdate -expand -group fft_ctrl /fft_control_tb/CONTROL/oSOURCE_CONT
...
WaveRestoreCursors {{Cursor 3} {26790 ns} 0}
...
update
WaveRestoreZoom {64432 ns} {204167 ns}
